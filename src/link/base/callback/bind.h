...
#ifndef LINK_BASE_CALLBACK_BIND_H_
#define LINK_BASE_CALLBACK_BIND_H_
...
struct MakeBindStateTypeImpl<true, Functor, Receiver, BoundArgs...> {
  using Type =
    BindState<decay_t<Functor>, decay_t<Receiver>, decay_t<BoundArgs>...>;
};
...
Callback<MakeUnboundRunType<Functor, Args...>> BindImpl(
...
template <typename Functor, typename... Args>
Callback<MakeUnboundRunType<Functor, Args...>> Bind(
  Functor&& functor, Args&&... args) {
